...
<asp:UpdatePanel runat="server" ID="ChildrenUpdatePanel">
    <ContentTemplate>
        <fieldset>
            ...
            <asp:GridView runat="server" ID="ItemList" AllowSorting="false" AutoGenerateColumns="false" AllowPaging="true" CssClass="DragDropGrid DataTable" OnPageIndexChanging="ItemList_PageIndexChanging" OnDataBound="ItemList_DataBound" Width="100%" PageSize="5" OnSorting="ItemList_Sorting">
                <Columns>
